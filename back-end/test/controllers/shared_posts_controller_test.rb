...
class SharedPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shared_post" do
    assert_difference("SharedPost.count") do
      post shared_posts_url, params: { shared_post: { description: @shared_post.description, post_id: @shared_post.post_id, user_id: @shared_post.user_id } }
    end
  ...
  test "should update shared_post" do
    patch shared_post_url(@shared_post), params: { shared_post: { description: @shared_post.description, post_id: @shared_post.post_id, user_id: @shared_post.user_id } }
